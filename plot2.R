...
# from the UC Irvine Machine Learning Repository and creates a line graph from the Global Active Power variable
...
# Plot
plot(hh_power.f$DateTime, hh_power.f$Global_active_power, type="n", ylab="Global Active Power (kilowatts)", xlab="")
lines(hh_power.f$DateTime, hh_power.f$Global_active_power, type="l")
